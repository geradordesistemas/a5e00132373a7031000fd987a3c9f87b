...
return [
    ...
    /** Schema Bundles */
    App\Application\Schema\AutorBundle\ApplicationSchemaAutorBundle::class => ['all' => true],
    App\Application\Schema\TipoDocumentoBundle\ApplicationSchemaTipoDocumentoBundle::class => ['all' => true],
    App\Application\Schema\DocumentoBundle\ApplicationSchemaDocumentoBundle::class => ['all' => true],
