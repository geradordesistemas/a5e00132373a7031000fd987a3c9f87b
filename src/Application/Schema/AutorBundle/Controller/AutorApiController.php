...
#[Route('/api/autor', name: 'api_autor_')]
#[OA\Tag(name: 'Autor')]
#[ACL\Api(enable: true, title: 'Autor', description: 'Permissões do modulo Autor')]
class AutorApiController extends BaseApiController
{
    ...
    new OA\Property(property: 'revisores', type: 'integer'),
    new OA\Property(property: 'documentos', type: 'object'),
                new OA\Property(property: 'id', type: 'integer'),
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar Autor')]
    public function editAction(Request $request, int $id): Response
    {
        ...
        if(!$object)
            return $this->json(['status' => false, 'message' => 'Autor não encontrado!'], 404);
    ...
    */
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar Autor')]
    public function deleteAction(int $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'Autor removido com sucesso.'], 204);
    }
