...
use App\Application\Schema\AutorBundle\Form\AutorType;
...
#[Route('/web/autor', name: 'web_autor_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Autor', description: 'Permissões do modulo Autor')]
class AutorWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationSchemaAutor/autor/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Autor')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Autor')]
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Autor')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Autor')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Autor')]
