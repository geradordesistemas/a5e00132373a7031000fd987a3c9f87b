...
#[ACL\Admin(enable: true, title: 'Documento', description: 'Permissões modulo Documento')]
class DocumentoAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Documento')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Documento')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Documento')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Documento')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Documento')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Documento em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Documento')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Documento')]
