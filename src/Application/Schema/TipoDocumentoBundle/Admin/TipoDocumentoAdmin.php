<?php
namespace App\Application\Schema\TipoDocumentoBundle\Admin;
...
final class TipoDocumentoAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof TipoDocumento ? $object->getId()
        .' - '.$object->getTipo()
        : '';
    }
