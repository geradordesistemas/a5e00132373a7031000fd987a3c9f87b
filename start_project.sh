...
./run.sh bin/console security:create-admin AlanGuedes alanguedes00@live.com a5e00132373a7031000fd987a3c9f87b

# Cria usuário padrão
./run.sh bin/console security:create-user AlanGuedes alanguedes00@live.com a5e00132373a7031000fd987a3c9f87b
